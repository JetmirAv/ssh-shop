...
import org.fiek.services.product.GetAllWishListService;
...
public class WishListController {
    ...
    void initialize() {
        ...
        GetAllWishListService service = new GetAllWishListService(user);

        service.start();

        service.setOnSucceeded(e->{

            ArrayList<Product> productsUser = productStore.getWishList();
            System.out.println("wishlist:" + productsUser.size());
